...
models=["iGR385", "MERLIN", "AGORA"]

data={'SBO Annotation' : [47,0,0],
'Gene Annotation' : [43,40,0],
'Metabolite Annotation' : [61,30,24],
'Reaction Annotation' : [76,50,22],
'Consistency' : [97,86,43],     #Manually recalculated the results of reactions updated to remove biomass precursor psuedorxns, known reactions that involve met formulae of X/R. This adjustment brough mass balance score to 100%
'Total Score' : [64,41,20]}     
